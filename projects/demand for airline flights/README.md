...
*Примечание:* Первая часть проекта с работой в SQL базе, выполнялась в рамках учебной платформы Яндекс Практикума. Здесь только аналитическая часть проекта.
